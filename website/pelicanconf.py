...
AUTHOR = 'Justin Fear'
SITENAME = 'NCBI Remap'
SITESUBTITLE = u'Remapping all public D. melanogaster sequencing data.'
SITEURL = 'https://jfear.github.io.com/jfear/ncbi_remap'
SITEGHURL = 'https://github.com/jfear/ncbi_remap'
SITESUBURL = 'ncbi_remap/'
PATH = 'content'
