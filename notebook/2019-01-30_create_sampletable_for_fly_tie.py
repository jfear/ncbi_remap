...
# %% [markdown]
# # Sample Table for Fly Tie.

# %% [markdown]
# I setup a new repository [fly_tie](https://github.com/jfear/fly_tie) to run StringTie optimizations. I want to use head data from the SRA for this process. Here I need to generate a set of ~100 high quality samples of head data for this process.
...
srxs = metadata.query('tissue == "head"').index.tolist()
...
#%%
# Remove white space
stranded_w_layout.samplename = stranded_w_layout.samplename.str.strip()
stranded_w_layout.Run = stranded_w_layout.Run.str.strip()

# %%
stranded_w_layout.to_csv('../output/notebook/2019-01-30_269_head_samples_for_fly_tie.tsv', sep='\t', index=False)
